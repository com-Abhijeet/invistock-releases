...
export default function CheckPrintModal({
  ...
  // Format date for display in DDMMYYYY order
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="lg" fullWidth>
        ...
        <Stack direction="row" spacing={1.5} alignItems="center">
          ...
          <Tooltip title="Delete Bank">
            <IconButton
              ...
              sx={{ color: "#fca5a5", bgcolor: "rgba(255,255,255,0.1)" }}
            >
              <Trash2 size={20} />
            </IconButton>
          </Tooltip>
      ...
      <DialogContent
        dividers
        sx={{ bgcolor: "#f8fafc", display: "flex", gap: 3, p: 3 }}
      >
        ...
        <Box sx={{ flex: 1, display: "flex", flexDirection: "column", gap: 2 }}>
              ...
              >
                ...
                <Box
                  sx={{
                    ...
                    display: "flex",
                    border:
                      selectedField === "date" ? "1px dashed #3b82f6" : "none",
                    bgcolor:
                      selectedField === "date"
                        ? "rgba(59, 130, 246, 0.1)"
                        : "transparent",
                ...
                >
                  {displayDate.split("").map((char, i) => (
                    <span
                      key={i}
                      style={{
                        width: `${config.fields.date.spacing}mm`,
                        textAlign: "center",
                      }}
                    >
                      {char}
                ...
                <Box
                  sx={{
                    ...
                    color: "#1e293b",
                    border:
                      selectedField === "payee" ? "1px dashed #3b82f6" : "none",
                    bgcolor:
                      selectedField === "payee"
                        ? "rgba(59, 130, 246, 0.1)"
                        : "transparent",
          ...
          >
            ...
            <Typography variant="body2" color="#92400e" fontSize="11px">
              Standard Indian cheques are <b>203mm x 93mm</b>. Always align the{" "}
              <b>D D M M Y Y Y Y</b> side first in the printer tray. If the
              print is off by 1mm, use the nudge controls to fine-tune.
            </Typography>
          </Paper>
        </Box>
      </DialogContent>
