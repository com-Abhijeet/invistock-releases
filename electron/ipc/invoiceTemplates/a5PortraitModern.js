...
const a5PortraitCentered = (data) => {
  ...
  // 2. Pagination (dynamic last-page capacity — reduced base to 15 for taller centered header)
  ...
  const pages = buildDynamicPages(items, ROWS_PER_PAGE, footerExtraRows, 5);
    ...
    <html>
      <head>
        ...
        <style>
          ...
          .qr-img { width: 65px; height: 65px; border: 1px solid #ddd; padding: 1px; border-radius: 4px; }
