...
const a5Landscape = (data) => {
    ...
    <div class="page-container">
        ...
        <div class="header-box">
          ...
          <div class="invoice-meta">
            <div class="flex-between"><span>${isQuoteDoc ? "Quote No:" : "Invoice No:"}</span> <span class="bold">${sale.reference_no}</span></div>
        ...
        <div class="footer-section">
          <div class="footer-left">
            <div>
              ...
              ${!isQuoteDoc && inclusiveTax ? `<div style="font-weight: bold; font-size: 9px; margin-top: 4px;">* All prices are inclusive of GST</div>` : ""}
            </div>
  ...
  const pages = buildDynamicPages(items, ROWS_PER_PAGE, footerExtraRows, 4);
    ...
    <html>
      <head>
        ...
        <style>
          ...
          h1 { margin: 0; font-size: 16px; text-transform: uppercase; color: #333; }
          ...
          .qr-img { width: 55px; height: 55px; border: 1px solid #ddd; padding: 1px; }
