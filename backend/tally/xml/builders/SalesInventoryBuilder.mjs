...
export class SalesInventoryBuilder {
  /**
  ...
  static build(doc, settings) {
    ...
    // We need to CREDIT the round-off ledger to balance the extra Debit in party amount.
    // exactRoundOff < 0 means the invoice total is lower, so we DEBIT the round-off ledger.
